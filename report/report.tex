...
%TODO: why use this instead of POSIX? Easy to write code for running processes in
%parallel?
%The primary goal of our library is to offer a developer run several processes in parallel
...
%\includegraphics[width=0.6\textwidth]{channel-state.png}
    \begin{tikzpicture}[node distance   = 4 cm]
      ...
      \Edge(NobodyWaiting)(ReaderWaiting)
      \Edge(NobodyWaiting)(WritterWaiting)
      \SetUpEdge[style={->,bend right,ultra thick}]
      \Edge(ReaderWaiting)(NobodyWaiting)
      \Edge(WritterWaiting)(NobodyWaiting)
